          ...
          {step === 1 && (
            <div className="p-6 space-y-6 fade-in">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <label className="block text-sm font-semibold text-foreground mb-1">
                    Single Trip Fare (USD) <span className="text-[color:var(--status-outdated)]">*</span>
                  </label>
                  <p className="text-xs text-muted-foreground mb-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      {...register('singleFare', {
                        ...
                        pattern: { value: /^\d+(\.\d{1,2})?$/, message: 'Enter a valid fare (e.g. 2.50)' },
                      })}
                      placeholder="0.00"
            ...
            <div className="p-6 space-y-6 fade-in">
              ...
              <div>
                ...
                <textarea
                  {...register('fareNotes')}
                  rows={4}
                  placeholder="e.g. Fare increase of $0.25 effective April 1, 2026. Transfers to bus within 2 hours are free."
            ...
            <div className="p-6 space-y-6 fade-in">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <ReviewSection title="Fare Details">
                  <ReviewRow label="Single Fare" value={watchedAll.singleFare ? `$${watchedAll.singleFare}` : '—'} mono />
                  <ReviewRow label="Weekly Pass" value={watchedAll.weeklyPass ? `$${watchedAll.weeklyPass}` : 'N/A'} mono />
                  <ReviewRow label="Monthly Pass" value={watchedAll.monthlyPass ? `$${watchedAll.monthlyPass}` : 'N/A'} mono />
                  ...
                  {watchedAll.hasPeakPricing && (
                    <>
                      <ReviewRow label="Peak Fare" value={`$${watchedAll.peakFare}`} mono />
                      <ReviewRow label="Off-Peak Fare" value={`$${watchedAll.offPeakFare}`} mono />
                    </>
                  )}
                </ReviewSection>
